...
class ScoreBoard:
    ...
    def __init__(self, game):
        ...
        self.high_score_font = pygame.font.SysFont(None, 72)
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(score_str, True, self.txt_color, None)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.high_score_font.render(high_score_str, True, self.txt_color, None)
    ...
    def prep_lvl(self):
        ...
        self.lvl_image = self.font.render(lvl_str, True, self.txt_color, None)
